...
public class ReadContextCounter//  extends SimpleVariant
{
            ...
            @Nullable QualityCalculator.QualityScores modifiedQualities, @Nullable final FragmentData fragmentData)
    {
        if(mVariantVis != null)
        {
            ...
            // TODO: Not in final.
            //            ReadEvidenceRecord readEvidence =
            //                    new ReadEvidenceRecord(mSample, chromosome(), ref(), alt(), matchType, record, mReadContext.indexedBases(), readIndex, quality);
            //            mReadEvidenceWriter.write(readEvidence);
        }
    }
