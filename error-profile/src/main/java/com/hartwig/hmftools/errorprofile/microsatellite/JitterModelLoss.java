...
import static com.hartwig.hmftools.errorprofile.microsatellite.JitterModelCalc.modifiedAsymmetricLaplace;

import it.unimi.dsi.fastutil.doubles.DoubleDoublePair;

public class JitterModelLoss
{
    private MicrosatelliteStatsTable.Row mStatsTableRow;
    private double mNumRepeats;
    private double mLengthMinusOneScale;

    public JitterModelLoss(MicrosatelliteStatsTable.Row statsTableRow, double numRepeats, double lengthMinusOneScale)
    {
    ...
    {
        double modelFreq = Math.max(modifiedAsymmetricLaplace(x, scale, skew), 1e-4);
